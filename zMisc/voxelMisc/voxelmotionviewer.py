"""
Interactive PyVista viewer for voxel grids (no screenshots).

Requirements:
    pip install pyvista numpy

Description:
    1) Loads voxel_grid.bin
    2) Extracts top percentile of brightness
    3) Optional Euler rotation
    4) Displays interactively (no automatic screenshots)
"""
